      ...
      <section className="bg-white border-b">
        <div className="max-w-5xl mx-auto px-4 py-20 text-center">
          <h1 className="text-4xl font-bold mb-4 leading-tight">
            특별한 날의 의상,<br />
            <span className="text-rose-500">이웃과 나눠요</span>
          </h1>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {CATEGORIES.map((cat) => (
            <Link
              ...
              className="bg-white rounded-xl border p-6 text-center hover:border-rose-300 hover:shadow-sm transition-all"
            >
        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
            {[
              ...
              <div key={step}>
                <div className="w-10 h-10 bg-rose-100 text-rose-600 rounded-full flex items-center justify-center font-bold text-lg mx-auto mb-3">
                  {step}
                </div>
